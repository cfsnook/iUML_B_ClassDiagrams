...
public class ClassdiagramsFactoryImpl extends EFactoryImpl implements ClassdiagramsFactory {
	...
	public static ClassdiagramsFactory init() {
		try {
			ClassdiagramsFactory theClassdiagramsFactory = (ClassdiagramsFactory)EPackage.Registry.INSTANCE.getEFactory("http://soton.ac.uk/models/eventb/classdiagrams/2020"); 
