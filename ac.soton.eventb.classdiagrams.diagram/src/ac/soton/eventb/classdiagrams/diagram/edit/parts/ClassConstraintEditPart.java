 ...
 * @generated
 */
public class ClassConstraintEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ClassConstraintItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ClassdiagramsParserProvider.getParser(ClassdiagramsElementTypes.ClassConstraint_3024,
					getParserElement(), ClassdiagramsVisualIDRegistry.getType(
							ac.soton.eventb.classdiagrams.diagram.edit.parts.ClassConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
