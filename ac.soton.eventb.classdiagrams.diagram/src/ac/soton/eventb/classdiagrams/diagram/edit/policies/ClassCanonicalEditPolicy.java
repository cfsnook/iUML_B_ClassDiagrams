...
public class ClassCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ClassdiagramsPackage.eINSTANCE.getClass_SubtypeGroups();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClass_2003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return SubtypeGroupEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClass_2003SemanticChildren((View) getHost().getModel());
