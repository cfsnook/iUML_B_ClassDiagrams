 ...
 * @generated
 */
public class ClassConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ClassConstraintEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassConstraintsCompartment_7008SemanticChildren((View) getHost().getModel());
