 ...
 * @generated
 */
public class ClassAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ClassAttributeEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassAttributesCompartment_7006SemanticChildren((View) getHost().getModel());
