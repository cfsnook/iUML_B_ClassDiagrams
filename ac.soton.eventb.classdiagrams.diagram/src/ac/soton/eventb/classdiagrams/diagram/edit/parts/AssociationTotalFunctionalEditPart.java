 ...
 * @generated
 */
public class AssociationTotalFunctionalEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	...
	static {
		registerSnapBackPosition(
				ClassdiagramsVisualIDRegistry.getType(
						ac.soton.eventb.classdiagrams.diagram.edit.parts.AssociationTotalFunctionalEditPart.VISUAL_ID),
				new Point(8, -5));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ClassdiagramsTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ClassdiagramsParserProvider.getParser(ClassdiagramsElementTypes.Association_4005,
					getParserElement(), ClassdiagramsVisualIDRegistry.getType(
							ac.soton.eventb.classdiagrams.diagram.edit.parts.AssociationTotalFunctionalEditPart.VISUAL_ID));
		}
		return parser;
	}
