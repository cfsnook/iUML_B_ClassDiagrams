...
import ac.soton.eventb.classdiagrams.diagram.edit.policies.StatemachineItemSemanticEditPolicy;
 ...
 * @since 2.0
 */
public class StatemachineEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ClassdiagramsParserProvider.getParser(ClassdiagramsElementTypes.Statemachine_3025,
					getParserElement(), ClassdiagramsVisualIDRegistry
							.getType(ac.soton.eventb.classdiagrams.diagram.edit.parts.StatemachineEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class StatemachineFigure extends WrappingLabel {
