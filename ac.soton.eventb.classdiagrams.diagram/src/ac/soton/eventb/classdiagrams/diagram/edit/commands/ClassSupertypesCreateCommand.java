...
public class ClassSupertypesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClassSupertypesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return ClassdiagramsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateClassSupertypes_4006(getSource(),
				getTarget());
	}
