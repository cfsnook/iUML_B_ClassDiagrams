 ...
 * @generated
 */
public class StatemachinesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return StatemachinesPackage.eINSTANCE.getStatemachineOwner_Statemachines();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassStatemachines_7009SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return StatemachineEditPart.VISUAL_ID == ClassdiagramsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ClassdiagramsNodeDescriptor> childDescriptors = ClassdiagramsDiagramUpdater
				.getClassStatemachines_7009SemanticChildren((View) getHost().getModel());
