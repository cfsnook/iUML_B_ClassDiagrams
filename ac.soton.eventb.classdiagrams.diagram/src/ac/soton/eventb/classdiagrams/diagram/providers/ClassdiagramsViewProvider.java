 ...
 * @generated
 */
public class ClassdiagramsViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ClassdiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& ClassdiagramsVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ClassdiagramsVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = ClassdiagramsVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				...
				if (!ClassdiagramEditPart.MODEL_ID
						.equals(ClassdiagramsVisualIDRegistry.getModelID(op.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!ClassdiagramsElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		...
		int visualID = ClassdiagramsVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ClassdiagramsVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = ClassdiagramsVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case AssociationEditPart.VISUAL_ID:
			return createAssociation_4005(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		case ClassSupertypesEditPart.VISUAL_ID:
			return createClassSupertypes_4006(containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createClassAttribute_3022(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
	...
	*/
	 ...
	 * @generated
	 */
	public Node createClassMethod_3023(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
		node.setType(ClassdiagramsVisualIDRegistry.getType(ClassMethodEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createClassConstraint_3024(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	...
	public Edge createAssociation_4005(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label6004 = createLabel(edge, ClassdiagramsVisualIDRegistry.getType(AssociationNameEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ClassdiagramEditPart.MODEL_ID.equals(ClassdiagramsVisualIDRegistry.getModelID(containerView))) {
