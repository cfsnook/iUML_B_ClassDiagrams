	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (element instanceof GraphicalEditPart) {
				EditPolicy policy = ((GraphicalEditPart) element).getEditPolicy(EditPolicyRoles.OPEN_ROLE);
				if (policy != null) {
					Command command = policy.getCommand(new Request(RequestConstants.REQ_OPEN));
