...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ClassdiagramsDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
	...
	protected Object getValue(EObject element, EStructuralFeature feature) {
		if (feature.getName().equals("surjective")) {
			return ((Boolean) element.eGet(feature)) ? "1" : "0";
		} else if (feature.getName().equals("injective")) {
			return ((Boolean) element.eGet(feature)) ? "1" : "n";
